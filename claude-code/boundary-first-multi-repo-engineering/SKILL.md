...
description: Boundary-first engineering workflow for multi-repo, multi-runtime, and contract-sensitive tasks. Use when a task may touch more than one repo, service, runtime, or contract surface. Prevents changing the wrong repo, missing contract boundaries, skipping rollback design, validating the wrong side.
---
